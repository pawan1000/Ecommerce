...
const Home = () => {
  ...
  return (
    <div className='home p-3' >
      <HomeNav />
      <hr></hr>
      {loader ? <LoadingSpinner /> : <div className='div-1' style={{ boxShadow: '1px 2px 9px white', borderRadius: '10px' }}>
      ...
      {/* third row */}
      {loader ? <LoadingSpinner /> : <div className='div-1' style={{ boxShadow: '1px 2px 9px #aaf4e5', borderRadius: '10px' }}>
